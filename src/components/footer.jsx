            ...
            <div className="bg-gray-100">
                <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
                    <p className="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">© 2024 written —
                        <Link href="https://t.me/tajiik_coder" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">khasonoff1@gmail.com</Link>
                    </p>
                    <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
                        ...
                        <Link href={"https://ins"} className="ml-3 text-gray-500">
