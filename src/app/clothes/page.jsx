            ...
            <section className="flex flex-col basis-[30%] px-10">
                <div className="flex flex-col">
                    ...
                    <div className="flex flex-col mt-4">
                        ...
                        <p className="text-2xl text-black mt-3 cursor-pointer">electronics</p>
                        <p className="text-2xl text-black mt-3 cursor-pointer">jewelery</p>
                        <p className="text-2xl text-black mt-3 cursor-pointer">men`s clothing</p>
                        <p className="text-2xl text-black mt-3 cursor-pointer">women`s clothing</p>
                    </div>
                </div>
            </section>
